...
class VehiclePricingRules:
    ...
    def validate_input(self, vehicle_data: Dict) -> Tuple[bool, List[str]]:
        ...
        if year and odometer:
            ...
            expected_max_mileage = vehicle_age * 15000  
            expected_min_mileage = vehicle_age * 5000 
